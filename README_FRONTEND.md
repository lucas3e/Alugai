...
Escolha o frontend que deseja contribuir:

1. Fork o projeto
2. Crie uma branch (`git checkout -b feature/MinhaFeature`)
3. Faça suas alterações em `mobile/` ou `web/`
4. Commit (`git commit -m 'Adiciona MinhaFeature'`)
...
⭐ **Escolha o frontend que melhor se adapta às suas necessidades!**

- 📱 **Mobile**: Para usuários em movimento
- 🌐 **Web**: Para acesso rápido via navegador
